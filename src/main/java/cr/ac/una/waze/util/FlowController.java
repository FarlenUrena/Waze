...
import cr.ac.una.waze.App;
import cr.ac.una.waze.controller.Controller;
...
public class FlowController {
    ...
    public void goMain() {
        try {
            this.mainStage.setScene(new Scene(FXMLLoader.load(App.class.getResource("/cr/ac/una/waze/view/Principal.fxml"), this.idioma)));
            this.mainStage.show();
